...
CXXFLAGS_RELEASE := $(CXX_STD_CPP11) $(CXX_OPTIMIZE_FLAG) $(CXX_RELEASE_FLAG)
CXXFLAGS_DEBUG := $(CXX_STD_CPP11) $(CXX_DEBUG_FLAG)
...
$(TEST_EXECUTABLE): $(OBJECTS_UNITTEST)
	$(LD) $(CXX_LINK_STDLIB) $(LDFLAGS) $(LDFLAGS_TEST) $^ $(CXX_OUTPUTFILE_FLAG) $@
