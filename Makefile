...
%_gTest.o: %.cpp
	$(CXX) $(CXXFLAGS) $(CXX_ARCH_DEF_FLAG) $(CXX_OPTIMIZE_FLAG) $(CXX_UNITTEST_FLAG) $(CXX_NOLINK_FLAG) $^ $(CXX_OUTPUTFILE_FLAG) $@

$(TEST_EXECUTABLE): $(OBJECTS_UNITTEST)
	$(LD) $(CXX_LINK_STDLIB) $(CXX_OPTIMIZE_FLAG)$(CXXFLAGS_DEBUG) $(LDFLAGS) $(LDFLAGS_TEST) $^ $(CXX_OUTPUTFILE_FLAG) $@
...
.PHONY: clean
clean:
	$(RM) $(EXECUTABLE) $(TEST_EXECUTABLE) $(OBJECTS) $(OBJECTS_UNITTEST) $(OBJECTS_PERFTEST)
